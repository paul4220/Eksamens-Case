...
<?php
$image_url='https://farstrup.dk/wp-content/uploads/Sofaborde_3800-e1632737633422.jpg';
?>
...
Navn:
    <select name="Navn" >  
      <option value="Sofabord 3800">Sofabord 3800</option>}  
</select> 
...
Farve :
    <select name="farve">  
      ...
      <option value="Hvid">Rød</option>  
      <option value="Grøn">Blå</option>   
    </select> 
